...
export default class BoardDown extends React.Component {
  ...
  render() {
    ...
    let BoardDown = "BoardDown"
    let displayValue = "block"
    if (this.detectaMobile()) {displayValue = "none"
    BoardDown = "BoardDownMobile"}
  return (
    <div className={BoardDown} >
        <a href="#FrameContent" style={{display: displayValue}}>ABOUT ME ©</a>
